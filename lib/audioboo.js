...
AudioBoo.prototype.postResource = function(src, data, callback){
	this.oa.getProtectedResource(src, "POST", this.oauth_access_token_key, this.oauth_access_token_secret,  callback);
}
